...
export class GooeyButterCakeCommentBox extends React.Component {
        ...
        return (
            <div id="commentWrapper">
                <div className="commentHeader">
                    ...
                    <form action="https://downsouthrecipes.herokuapp.com/gooey-butter-cake" method="POST" className="form">                    
