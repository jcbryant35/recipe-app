...
export class CollardGreensCommentBox extends React.Component {
    ...
    addReview() {
        ...
        Axios({
            method: 'POST',
            url: 'https://downsouthrecipes.herokuapp.com/collard-greens/reviews', 
            headers: {
    ...
    componentDidMount() {
        ...
        Axios.get('https://downsouthrecipes.herokuapp.com/collard-greens')
        .then(reviews => {
    ...
    handleRate( { rating }) {
        ...
        Axios({
            method: 'POST',
            url: 'https://downsouthrecipes.herokuapp.com/collard-greens/',  
            headers: {
                'Content-Type': 'application/json'
            },
            data: {
        ...
        return (
            <div id="commentWrapper">
                <div className="commentHeader">
                    ...
                    <form action="https://downsouthrecipes.herokuapp.com/collard-greens" method="POST" className="form">
