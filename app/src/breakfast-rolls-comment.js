...
export class SausageBreakfastRollsCommentBox extends React.Component {
    ...
    addReview() {
        ...
        Axios({
            method: 'POST',
            url: 'http://localhost:8080/sausage-breakfast-rolls/reviews', 
            headers: {
    ...
    componentDidMount() {
        ...
        Axios.get('http://localhost:8080/sausage-breakfast-rolls')
        .then(reviews => {
    ...
    handleRate( { rating }) {
        ...
        Axios({
            method: 'POST',
            url: 'http://localhost:8080/sausage-breakfast-rolls/',  
            headers: {
                'Content-Type': 'application/json'
            },
            data: {
