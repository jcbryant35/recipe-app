...
export class BreakfastTacoCommentBox extends React.Component {
    ...
    addReview() {
        ...
        Axios({
            method: 'POST',
            url: 'downsouthrecipes.herokuapp.com/breakfast-tacos/',
            headers: {
    ...
    componentDidMount() {
        Axios.get('downsouthrecipes.herokuapp.com/breakfast')
        .then(reviews => {
        ...
        return (
            <div id="commentWrapper">
                <div className="commentHeader">
                    ...
                    <form action="/breakfast-tacos" method="POST" className='form'>
