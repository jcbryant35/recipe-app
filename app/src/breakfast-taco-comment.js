...
export class BreakfastTacoCommentBox extends React.Component {
    ...
    handleRate( { rating }) {
        ...
        Axios({
            ...
            headers: {
                'Content-Type': 'application/json',
                'Access-Control-Allow-Origin': 'https://downsouthrecipes.netlify.app/breakfast'
            },
            data: {
                rating: rating
            }
        ...
        return (
            <div id="commentWrapper">
                <div className="commentHeader">
                    ...
                    <form action="https://downsouthrecipes.herokuapp.com/breakfast-tacos" method="POST" className='form'>
                        ...
                        <input type="text" placeholder="Your name" name="username" className="userInput"/>
                        <br />
