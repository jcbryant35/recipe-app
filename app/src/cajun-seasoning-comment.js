...
export class CajunHouseSeasoningCommentBox extends React.Component {
        ...
        return (
            <div id="commentWrapper">
                <div className="commentHeader">
                    ...
                    <form action="https://downsouthrecipes.herokuapp.com/cajun-seasoning" method="POST" className="form" >                   
