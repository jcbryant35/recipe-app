...
export class BreakfastBurritoCommentBox extends React.Component {
        ...
        return (
            <div id="commentWrapper">
                <div className="commentHeader">
                    ...
                    <form action="https://downsouthrecipes.herokuapp.com/breakfast-burritos" method="POST" className="form">                    
