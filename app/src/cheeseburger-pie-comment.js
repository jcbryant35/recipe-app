...
export class CheeseburgerPieCommentBox extends React.Component {
        ...
        return (
            <div id="commentWrapper">
                <div className="commentHeader">
                    ...
                    <form action="https://downsouthrecipes.herokuapp.com/cheeseburger-pie" method="POST" className="form">
