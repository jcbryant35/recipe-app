...
export class BiscuitsGravyCommentBox extends React.Component {
        ...
        return (
            <div id="commentWrapper">
                <div className="commentHeader">
                    ...
                    <form action="https://downsouthrecipes.herokuapp.com/biscuits-gravy" method="POST" className="form">                    
