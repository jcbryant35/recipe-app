...
export class DummyStewCommentBox extends React.Component {
    ...
    addReview() {
        ...
        Axios({
            method: 'POST',
            url: 'https://downsouthrecipes.herokuapp.com/dummy-stew/reviews', 
            headers: {
    ...
    componentDidMount() {
        ...
        Axios.get('https://downsouthrecipes.herokuapp.com/dummy-stew')
        .then(reviews => {
    ...
    handleRate( { rating }) {
        ...
        Axios({
            method: 'POST',
            url: 'https://downsouthrecipes.herokuapp.com/dummy-stew/',  
            headers: {
                'Content-Type': 'application/json'
            },
            data: {
        ...
        return (
            <div id="commentWrapper">
                <div className="commentHeader">
                    ...
                    <form action="https://downsouthrecipes.herokuapp.com/dummy-stew" method="POST" className="form">                   
