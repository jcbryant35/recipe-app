...
export class ChickenDumplingsCommentBox extends React.Component {
    ...
    addReview() {
        ...
        Axios({
            method: 'POST',
            url: 'https://downsouthrecipes.herokuapp.com/chicken-dumplings/reviews', 
            headers: {
    ...
    componentDidMount() {
        ...
        Axios.get('https://downsouthrecipes.herokuapp.com/chicken-dumplings')
        .then(reviews => {
    ...
    handleRate( { rating }) {
        ...
        Axios({
            method: 'POST',
            url: 'https://downsouthrecipes.herokuapp.com/chicken-dumplings/',  
            headers: {
                'Content-Type': 'application/json'
            },
            data: {
        ...
        return (
            <div id="commentWrapper">
                <div className="commentHeader">
                    ...
                    <form action="https://downsouthrecipes.herokuapp.com/chicken-dumplings" method="POST" className="form" >                   
