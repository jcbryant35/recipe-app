...
export class CrabCornChowderCommentBox extends React.Component {
    ...
    addReview() {
        ...
        Axios({
            method: 'POST',
            url: 'https://downsouthrecipes.herokuapp.com/crab-corn-chowder/reviews', 
            headers: {
    ...
    componentDidMount() {
        ...
        Axios.get('https://downsouthrecipes.herokuapp.com/crab-corn-chowder')
        .then(reviews => {
    ...
    handleRate( { rating }) {
        ...
        Axios({
            method: 'POST',
            url: 'https://downsouthrecipes.herokuapp.com/crab-corn-chowder/',  
            headers: {
                'Content-Type': 'application/json'
            },
            data: {
        ...
        return (
            <div id="commentWrapper">
                <div className="commentHeader">
                    ...
                    <form className="form" action="https://downsouthrecipes.herokuapp.com/crab-corn-chowder" method="POST" >                   
