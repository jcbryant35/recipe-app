...
export class HouseSeasoningCommentBox extends React.Component {
    ...
    addReview() {
        ...
        Axios({
            method: 'POST',
            url: 'https://downsouthrecipes.herokuapp.com/house-seasoning/reviews', 
            headers: {
    ...
    componentDidMount() {
        ...
        Axios.get('https://downsouthrecipes.herokuapp.com/house-seasoning')
        .then(reviews => {
    ...
    handleRate( { rating }) {
        ...
        Axios({
            method: 'POST',
            url: 'https://downsouthrecipes.herokuapp.com/house-seasoning/',  
            headers: {
                'Content-Type': 'application/json'
            },
            data: {
        ...
        return (
            <div id="commentWrapper">
                <div className="commentHeader">
                    ...
                    <form action="https://downsouthrecipes.herokuapp.com/house-seasoning" method="POST" className="form" >
