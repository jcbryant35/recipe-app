...
export class SquashAuGratinCommentBox extends React.Component {
        ...
        return (
            <div id="commentWrapper">
                <div className="commentHeader">
                    ...
                    <form action="https://downsouthrecipes.herokuapp.com/squash-au-gratin" method="POST" className="form" >                  
